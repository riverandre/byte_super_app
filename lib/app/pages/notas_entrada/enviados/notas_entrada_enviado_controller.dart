...
class NotasEntradaEnviadoController extends GetxController
  ...
  Future<void> _getNotas() async {
    try {
      ...
      final notasLocal = await _notasEntradaRepository.findNotasLocalEnviado();
