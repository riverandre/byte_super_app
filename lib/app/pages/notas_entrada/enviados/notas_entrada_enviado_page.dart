...
class NotasEntradaEnviadoPage extends StatefulWidget {
  const NotasEntradaEnviadoPage({super.key});

  @override
  State<NotasEntradaEnviadoPage> createState() =>
      _NotasEntradaEnviadoPageState();
}

class _NotasEntradaEnviadoPageState
    extends PdvState<NotasEntradaEnviadoPage, NotasEntradaEnviadoController> {
  @override
  void initState() {
    super.initState();

    NotasEntradaEnviadoBindings().dependencies();
  }
